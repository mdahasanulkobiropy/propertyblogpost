        ...
        <div class="pxp-content">
            <div class="pxp-contact pxp-content-wrapper mt-100">
                ...
                <div class="pxp-contact-hero mt-4 mt-md-5">
                    <div class="pxp-contact-hero-fig pxp-cover" style="background-image: url('{{asset('frontend/assets/./assets/images/sub-banners/contact-bg.jpg')}}'); background-position: 50% 80%;"></div>
