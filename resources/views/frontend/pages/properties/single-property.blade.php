                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-5">
                            <h2 class="pxp-sp-top-title">Beautiful House in Marina</h2>
                            <p class="pxp-sp-top-address pxp-text-light">542 29th Avenue, Marina District, San Francisco, CA 94121</p>
                        </div>
                        <div class="col-sm-12 col-md-7">
                            ...
                            <div class="pxp-sp-top-price mt-3 mt-md-0">$5,198,000</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="pxp-single-property-section pxp-sp-agent-section mt-4 mt-md-5 mt-lg-0">
                            ...
                            <div class="pxp-sp-agent mt-3 mt-md-4">
                                <a href="single-agent.html" class="pxp-sp-agent-fig pxp-cover rounded-lg" style="background-image: url(./assets/images/agents/agent-4.jpg); background-position: top center"></a>
