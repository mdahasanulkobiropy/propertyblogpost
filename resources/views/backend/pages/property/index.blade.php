    ...
    @section('content')
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="row">
                    <form action="{{route('admin.poterty.add')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12">
                            <div class="border border-3 p-4 rounded">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{old('title')}}" name="title"  placeholder="Enter Property title">
                                </div>
                                <div class="mb-3">
                                    <div class="mb-3">
                                        @error('location')
                                    ...
                                    <input type="text" class="form-control"  value="{{old('location')}}" name="location"  placeholder="Enter Property Location">
                                </div>
                                <div class="mb-3">
                                    <div class="mb-3">
                                        @error('description')
                            ...
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control" value="{{old('price')}}" name="price" placeholder="$00.00">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            @error('year_built')
                                        ...
                                        <input type="text" class="form-control" value="{{old('year_built')}}" name="year_built" placeholder="y-y-y-y">
                                    </div>
                                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control" value="{{old('button_text')}}" name="button_text" placeholder="button_text">
                                    </div>
                                    <div class="col-md-8">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="form-select agent_select" id="agent_select" name="agent_id">
                                            ...
                                            @foreach ($agents as $agent)
                                                <option value="{{$agent->agent_id}}">{{$agent->getUserAgent->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-12">
