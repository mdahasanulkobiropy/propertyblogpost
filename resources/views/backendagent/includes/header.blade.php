        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{asset('backend/upload/image/agent')}}/{{Auth::user()->getAgent->image}}" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{Auth::user()->name}}</p>
                        <p class="designattion mb-0">{{Auth::user()->getAgent->license}}</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a href="{{route('agent.massage')}}" class="dropdown-item" href="javascript:;"><i class='bx bx-chat'></i><span>Massage</span></a>
                    </li>
                    <li>
